...
try {
    ...
    $image_principale = $images[0]['chemin_image'] ?? '';
    ...
    if (isset($_GET['action']) && $_GET['action'] === 'add_to_cart') {
        ...
        $cartItem = [
            ...
            'Nom' => $produit['Nom'],
            'Prix' => $produit['Prix'],
            'Image' => $image_principale // Ajouter le chemin de l'image
        ];
...
<body>
    ...
    <div class="titre-detail">
        <h3>Details du produit <?= htmlspecialchars($produit['Nom']) ?></h3>
    </div>
    ...
    <section class="product-detail">
        ...
        <div class="product-info">
            ...
            <div class="features">
                ...
                <?php elseif ($type_produit == 'peripherique_reseau' || $type_produit == 'telephonie'): ?>
                    <ul>
