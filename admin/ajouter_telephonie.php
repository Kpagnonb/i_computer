...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        // Insertion des données du produit dans la base de données
        $sql = "INSERT INTO telephonie (Nom, Description, Prix, Marque, TypeProduit, DateAjout) 
        ...
        // Gestion du téléchargement des fichiers multiples
        if (isset($_FILES['images']) && $_FILES['images']['error'][0] == 0) {
            ...
            foreach ($_FILES['images']['tmp_name'] as $key => $tmp_name) {
                ...
                if (move_uploaded_file($tmp_name, $target_file)) {
                    ...
                    // Insertion du chemin de l'image dans la table des images
                    $sql_image = "INSERT INTO images_telephonie (id_produit, chemin_image) 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="ajouter_telephonie.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="typeProduit" name="typeProduit">
                                ...
                                <option value="Accessoire téléphone">Accessoire téléphone</option>
